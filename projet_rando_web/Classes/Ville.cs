...
namespace projet_rando_web.Classes
{
    public class Ville
    {
        ...
        /// Obtient ou définit le nom de la ville.
        /// </summary>
        [BsonElement("Latitude"), BsonRepresentation(BsonType.Decimal128)]
        public float Latitude { get; set; }

        /// <summary>
        /// Obtient ou définit le nom de la ville.
        /// </summary>
        [BsonElement("Longitude"), BsonRepresentation(BsonType.Decimal128)]
        ...
        public Ville(string id, Pays pays, string nom, float latitude, float longitude)
        {
            Id = id;
            Nom = nom;
            Latitude = latitude;
